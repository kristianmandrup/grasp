...
(function(){
  var ref$, map, flatten, join, lines, unlines, chars, unchars, syntax, syntaxFlat, aliasMap, attrMapInverse, matchesMap, matchesAliasMap, pad, options, generateSyntaxHelp, generateSyntaxHelpForNode, generateCategoryHelp, generateHelpForCategory, positionalHelp;
  ...
  positionalHelp = function(arg$){
    var generateHelp, generateHelpForOption, positional, interpolate, helpStrings, res$, i$, len$, arg, lresult$, that, dashes, optionName, j$, ref$, len1$, o, item, sep, name;
    generateHelp = arg$.generateHelp, generateHelpForOption = arg$.generateHelpForOption, positional = arg$.positional, interpolate = arg$.interpolate;
    res$ = [];
