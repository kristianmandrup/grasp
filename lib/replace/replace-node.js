...
(function(){
  var getReplacementFunc, lines, ReplaceNode, slice$ = [].slice;
  ...
  module.exports = ReplaceNode = (function(){
    ...
    function ReplaceNode(arg$){
      this.nodes = arg$.nodes, this.input = arg$.input, this.replacement = arg$.replacement, this.queryEngine = arg$.queryEngine;
      ...
      this.replaceNode = getReplacementFunc(this.replacement, this.input, this.queryEngine);
    }
    iterate(function(){
    ...
    process(node)(function(){
      ...
      this.replaceLines = lines(replaceNode(node));
