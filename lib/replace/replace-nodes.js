...
(function(){
  var getReplacementFunc, lines, createReplaceNodes, ReplaceNode, slice$ = [].slice;
  getReplacementFunc = require('./replacement').getReplacementFunc;
  lines = require('prelude-ls').lines;
  createReplaceNodes = function(replacement, input, nodes, queryEngine, actions){
    return new ReplaceNodes(replacement, input, nodes, queryEngine, actions);
  };
  ReplaceNode = (function(){
    ...
    process(node)(function(){
      ...
      this.replaceLines = lines(this.replaceNode(node));
    ...
    module.exports = [createReplaceNodes, ReplaceNode];
    return ReplaceNode;
  }());
}).call(this);
