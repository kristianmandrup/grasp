...
(function(){
  var levn, filterRegex, getArgs, hasFilter, parseFilters, extractReplacement, getRaw, slice$ = [].slice;
  levn = require('levn');
  ...
  extractReplacement = function(replacement, actions){
  ...
  module.exports = [getRaw, getArgs, extractReplacement];
}).call(this);
