...
(function(){
  var extraxt, getOrigResults, ref$, getArgs, getRaw, processFilters, makeOutput, getOutput, processOrig, replacer;
  extraxt = require('./replacement').extraxt;
  getOrigResults = require('./orig-results').getOrigResults;
  ref$ = require('.utils'), getArgs = ref$.getArgs, getRaw = ref$.getRaw;
  processFilters = function(arg$){
    var results, textOperations, filters, actions, raw, filterName, args, results$ = [];
    results = arg$.results, textOperations = arg$.textOperations, filters = arg$.filters, actions = arg$.actions, raw = arg$.raw;
  ...
  replacer = function(input, node, queryEngine, actions){
    return function(arg$, replacementArg){
      ...
      ref$ = extract(replacementArg, actions), selector = ref$[0], filters = ref$[1];
